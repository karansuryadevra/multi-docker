docker build -t karansuryadevra/multi-client:latest -t karansuryadevra/multi-client:$SHA -f ./client/Dockerfile ./client
docker build -t karansuryadevra/multi-server:latest -t karansuryadevra/multi-server:$SHA -f ./server/Dockerfile ./server
docker build -t karansuryadevra/multi-worker:latest -t karansuryadevra/multi-worker:$SHA -f ./worker/Dockerfile ./worker
